    ...
    // Armazena o ID da textura por nome do material
    std::unordered_map<std::string, GLuint> g_TextureMap;
    ...
    int main(int argc, char* argv[])
    {
        ...
        LoadAllTextures(&spheremodel, "../../data/car/");
    ...
    void DrawVirtualObject(const char* object_name)
    {
        ...
        std::string material_name = object_name; // Você pode mapear corretamente aqui se quiser

        auto it = g_TextureMap.find(material_name);
    ...
    void LoadAllTextures(ObjModel* model, const std::string& basepath)
    {
        for (const auto& material : model->materials)
        {
            if (!material.diffuse_texname.empty())
            {
                std::string texpath = basepath + material.diffuse_texname;
                GLuint texID = LoadTextureFromFile(texpath.c_str());
                g_TextureMap[material.name] = texID;
