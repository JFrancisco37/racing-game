...
void main()
{
    ...
    vec3 I = vec3(1.0,1.0,1.0); // PREENCH AQUI OK o espectro da fonte de luz
    ...
    vec3 phong_specular_term = Ks * I * pow( max(dot(r, v), 0.0), q ); // PREENCH AQUI OK o termo especular de Phong
